...
$(document).ready(function ()
{
    ...
    function getstream(dataUrl)
    {
        ...
        socket.on('m', function (currentData)
        {
            ...
            {
                var newTrade = transformData(currentData);
        ...
        var displayData = function (dataUnpacked)
        {
            ...
            $('#trades').after("<tr class=" + dataUnpacked.Type + "><th>" + dataUnpacked.Market + "</th><th>" + dataUnpacked.Type + "</th><th>" + dataUnpacked.Price + "</th><th>" + dataUnpacked.Quantity + "</th><th>" + dataUnpacked.Total + "</th></tr>");
